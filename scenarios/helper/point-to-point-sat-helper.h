 ...
 */
#ifndef POINT_TO_POINT_SAT_HELPER_H
#define POINT_TO_POINT_SAT_HELPER_H
 ...
 * "mixins".
 */
class PointToPointSatHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a PointToPointSatHelper to make life easier when creating point to
   * point networks.
   */
  PointToPointSatHelper ();
  virtual ~PointToPointSatHelper () {}
   ...
   * PointToPointNetDevice created through PointToPointSatHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::Queue created by PointToPointSatHelper::Install
   */
  void
   ...
   * by PointToPointSatHelper::Install
   */
   ...
   * attributes configured by PointToPointSatHelper::SetChannelAttribute,
...
#endif /* POINT_TO_POINT_SAT_HELPER_H */
