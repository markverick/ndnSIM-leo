...
#ifndef NDNSIM_HELPER_NDN_LEO_STACK_HELPER_H
#define NDNSIM_HELPER_NDN_LEO_STACK_HELPER_H
 ...
 */
class LeoStackHelper : boost::noncopyable {
public:
  /**
   * \brief Create a new NdnLeoStackHelper with a default NDN_FLOODING forwarding stategy
   */
  LeoStackHelper();

  /**
   * \brief Destroy the NdnLeoStackHelper
   */
...
#endif // NDNSIM_HELPER_NDN_LEO_STACK_HELPER_HPP
