...
#ifndef NDN_GSL_NET_DEVICE_TRANSPORT_HPP
#define NDN_GSL_NET_DEVICE_TRANSPORT_HPP
 ...
 */
class GSLNetDeviceTransport : public nfd::face::Transport
{
public:
  GSLNetDeviceTransport(Ptr<Node> node, const Ptr<NetDevice>& netDevice,
