...
#ifndef NDN_SAT_NET_DEVICE_TRANSPORT_HPP
#define NDN_SAT_NET_DEVICE_TRANSPORT_HPP
 ...
 */
class SatNetDeviceTransport : public nfd::face::Transport
{
public:
  SatNetDeviceTransport(Ptr<Node> node, const Ptr<NetDevice>& netDevice,
