...
#ifndef NDN_SAT_L3_PROTOCOL_H
#define NDN_SAT_L3_PROTOCOL_H
 ...
 */
class SatL3Protocol : boost::noncopyable, public Object {
public:
  /**
   * \brief Interface ID
   *
...
public: // Workaround for python bindings
  static Ptr<SatL3Protocol>
  getSatL3Protocol(Ptr<Object> node);
