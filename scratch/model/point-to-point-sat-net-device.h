...
#ifndef POINT_TO_POINT_SAT_NET_DEVICE_H
#define POINT_TO_POINT_SAT_NET_DEVICE_H
 ...
 * \class PointToPointSatNetDevice
 * \brief A Device for a Point to Point Network Link.
 *
 * This PointToPointSatNetDevice class specializes the NetDevice abstract
 * base class.  Together with a PointToPointSatChannel (and a peer 
 * PointToPointSatNetDevice), the class models, with some level of 
 ...
 * propagation delay is set in the PointToPointSatChannel).
 */
class PointToPointSatNetDevice : public NetDevice
{
public:
  /**
  ...
  /**
   * Construct a PointToPointSatNetDevice
   *
   * This is the constructor for the PointToPointSatNetDevice.  It takes as a
   * parameter a pointer to the Node to which this device is connected, 
   * as well as an optional DataRate object.
   */
  PointToPointSatNetDevice ();

  /**
   * Destroy a PointToPointSatNetDevice
   *
   * This is the destructor for the PointToPointSatNetDevice.
   */
  virtual ~PointToPointSatNetDevice ();
   ...
   */
  bool Attach (Ptr<PointToPointSatChannel> ch);

  /**
   * Attach a queue to the PointToPointSatNetDevice.
   *
   * The PointToPointSatNetDevice "owns" a queue that implements a queueing 
  ...
  /**
   * Attach a receive ErrorModel to the PointToPointSatNetDevice.
   *
   * The PointToPointSatNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected PointToPointSatChannel.
   *
   * The PointToPointSatNetDevice receives packets from its connected channel
...
private:
   ...
   */
  PointToPointSatNetDevice& operator = (const PointToPointSatNetDevice &o);
   ...
   * \param o Other NetDevice
   */
  PointToPointSatNetDevice (const PointToPointSatNetDevice &o);
...
private:
   ...
   * PointToPointSatNetDevice to begin the process of sending a packet out on
   * the channel.  The corresponding method is called on the channel to let
   * it know that the physical device this class represents has virtually
   * started sending signals.  An event is scheduled for the time at which
   * the bits have been completely transmitted.
   *
   * \see PointToPointSatChannel::TransmitStart ()
  ...
  /**
   * The PointToPointSatChannel to which this PointToPointSatNetDevice has been
   * attached.
   */
  Ptr<PointToPointSatChannel> m_channel;

  /**
   * The Queue which this PointToPointSatNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the PointToPointSatNetDevice
...
#endif /* POINT_TO_POINT_SAT_NET_DEVICE_H */
